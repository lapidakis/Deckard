...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ServiceReminders", targets: ["ServiceReminders"]),
        .library(name: "ServiceContacts", targets: ["ServiceContacts"]),
    ],
    dependencies: [
